class Registration
  ...
  attr_accessible :address, :business_name, :city, :country_id, :email, :first_name, :last_name, :password, :password_confirmation, :plan_id, :postal_code, :state_id, :subdomain, :url

  attr_accessor :address, :business_name, :city, :country_id, :email, :first_name, :last_name, :password, :password_confirmation, :plan_id, :postal_code, :state_id, :subdomain, :url
