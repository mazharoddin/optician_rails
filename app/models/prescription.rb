...
#  validates :expiry_date
  ...
  validates :od_add, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 5 }
  validates :od_axis, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 180, :integer_only => true }
  validates :od_base1, :inclusion => { :in => %w( down up ) }
  validates :od_base2, :inclusion => { :in => %w( down up ) }
#  validates :od_base_curve
  validates :od_cylinder, :numericality => { :greater_than_or_equal_to => -30, :less_than_or_equal_to => 30 }
#  validates :od_diameter
#  validates :od_prism1
#  validates :od_prism2
  validates :od_sphere, :numericality => { :greater_than_or_equal_to => -30, :less_than_or_equal_to => 30 }
  validates :optometrist_id, :presence => true
  validates :os_add, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 5 }
  validates :os_axis, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 180, :integer_only => true }
  validates :os_base1, :inclusion => { :in => %w( down up ) }
  validates :os_base2, :inclusion => { :in => %w( down up ) }
#  validates :os_base_curve
  validates :os_cylinder, :numericality => { :greater_than_or_equal_to => -30, :less_than_or_equal_to => 30 }
#  validates :os_diameter
#  validates :os_prism1
#  validates :os_prism2
  validates :os_sphere, :numericality => { :greater_than_or_equal_to => -30, :less_than_or_equal_to => 30 }
